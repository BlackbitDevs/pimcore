...
class DataObjectController extends ElementControllerBase implements KernelControllerEventInterface
{
    ...
    public function checkValidityAction(Request $request)
    {
        ...
        $checkValue = $fieldDefinition->getDataFromEditmode(json_decode($request->get('data'), true), $currentObject);
        try {
            $fieldDefinition->checkValidity($checkValue, false, ['object' => $currentObject]);
