...
final class Version20220201075121 extends AbstractMigration
{
    ...
    {
        $directoryIterator = new \RecursiveDirectoryIterator(PIMCORE_TEMPORARY_DIRECTORY.'/image-thumbnails', \RecursiveDirectoryIterator::SKIP_DOTS);
        ...
        try {
            ...
            /** @var SplFileInfo $thumbnailFile */
            foreach ($directoryIterator as $thumbnailFile) {
                if(preg_match('/^image-thumb__\d+__/', $thumbnailFile->getPathname())) {
